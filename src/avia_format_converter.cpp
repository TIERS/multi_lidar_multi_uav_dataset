...
int main(int argc, char** argv) {
    ...
    ros::Subscriber sub_livox_lidar = nh.subscribe<livox_ros_driver::CustomMsg>("/avia/livox/lidar", 100, livoxLidarHandler);
    pub_ros_points = nh.advertise<sensor_msgs::PointCloud2>("/avia_points", 100);
